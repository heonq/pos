...
- [ ] 선택한 결제수단을 저장한다.
- [ ] 선택한 결제수단과 할인적용을 제외하고 모든 결제수단에 'selected' class를 제거한다.
- [ ] 선택한 결제수단에 'selected' class를 추가한다.
...
- [ ] 취소를 누르면 변경사항 취소
- [ ] 초기화를 누르면 할인 초기화
- [ ] 할인이 적용된 상태에서 버튼을 다시 누르면 적용한 할인이 표시된다.
- [ ] 할인율이 적용되면 'selected' class를 추가한다.
- [ ] 할인율을 초기화하면 'selected' class를 제거한다.
