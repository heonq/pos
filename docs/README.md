...
상품 정보를 변경할 땐 상품을 생성할 때와 [동일한 조건](#상품-등록에-필요한-정보)이 적용됩니다.
...
카테고리의 이름을 수정할 때도 카테고리를 등록할 때와 [동일한 조건](#카테고리-이름-조건)이 적용됩니다.
...
맨 처음 판매통계 창을 열면 가장 최근 날짜부터 50개까지 표시합니다.(이미지는 예시를 위해 5개로 표시했습니다.)
